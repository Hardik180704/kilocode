...
export const dict = {
  ...
  "settings.sandboxing.hint":
    "Wijzigingen in netwerk, bestemmingen en schrijfbare paden gelden alleen voor nieuwe sessies. Bestaande sessies behouden het beleid waarmee ze zijn gestart.",
