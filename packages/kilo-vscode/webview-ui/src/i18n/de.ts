...
export const dict = {
  ...
  "settings.sandboxing.hint":
    "Änderungen an Netzwerk, Zielen und beschreibbaren Pfaden gelten nur für neue Sitzungen. Bestehende Sitzungen behalten die Richtlinie bei, mit der sie gestartet wurden.",
