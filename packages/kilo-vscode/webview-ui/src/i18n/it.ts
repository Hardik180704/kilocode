...
export const dict = {
  ...
  "settings.sandboxing.hint":
    "Le modifiche a rete, destinazioni e percorsi scrivibili si applicano solo alle nuove sessioni. Le sessioni esistenti mantengono la policy con cui sono state avviate.",
